...
exports.SARCASTIC_QUOTES = void 0;
exports.getRandomQuote = getRandomQuote;
exports.getPowerUpMessage = getPowerUpMessage;
const enums_1 = require("./enums");
exports.SARCASTIC_QUOTES = {
    wrong: [
...
function getRandomQuote(type) {
    const pool = exports.SARCASTIC_QUOTES[type];
    return pool[Math.floor(Math.random() * pool.length)];
}
const POWER_UP_QUOTES = {
    [enums_1.PowerUpType.Shield]: {
    ...
    [enums_1.PowerUpType.FiftyFifty]: {
    ...
    [enums_1.PowerUpType.DoubleDown]: {
    ...
    [enums_1.PowerUpType.DoublePick]: {
...
function getPowerUpMessage(params) {
    const entry = POWER_UP_QUOTES[params.type];
    if (!entry)
        return params.language === "ar" ? "تم استخدام قوة خاصة." : "A power-up was used.";
